...
/* ── API ─────────────────────────────────────────────────────────────────── */
const api = {
  search: (q, limit) => fetch(`/api/search?query=${encodeURIComponent(q)}&limit=${limit||6}`).then(r=>r.json()),
  movies:    { list: ()=>fetch('/api/movies').then(r=>r.json()),
               ...
               bulk: body=>fetch('/api/movies/bulk',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(body)}).then(r=>r.json()) },
  tv:        { list: ()=>fetch('/api/tv').then(r=>r.json()),
               bulk: body=>fetch('/api/tv/bulk',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(body)}).then(r=>r.json()),
  ...
  adult: {
    ...
    bulk: (body)=>adultFetch('/api/adult/bulk',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(body)}).then(r=>r.json()),
  ...
  audiobooks:{ list: ()=>fetch('/api/audiobooks').then(r=>r.json()),
               ...
               bulk: body=>fetch('/api/audiobooks/bulk',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(body)}).then(r=>r.json()) },
  comics:    { list: ()=>fetch('/api/comics').then(r=>r.json()),
               ...
               bulk: body=>fetch('/api/comics/bulk',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(body)}).then(r=>r.json()),
               interactive: id=>fetch(`/api/comics/${id}/interactive-search`).then(r=>r.json()),
               releases: id=>fetch(`/api/comics/${id}/releases`).then(r=>r.json()),
               manga: ()=>fetch('/api/comics/manga').then(r=>r.json()),
               tagManga: id=>fetch(`/api/comics/${id}/tag-manga`,{method:'PATCH'}).then(r=>r.json()),
               ...
               issueProgress: (issueId,body)=>fetch(`/api/comics/issues/${issueId}/progress`,{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(body)}).then(r=>r.json()),
               searchIssue: (id,issueId)=>fetch(`/api/comics/${id}/issues/${issueId}/search`,{method:'POST'}).then(r=>r.json()),
               grabIssue: (id,issueId,body)=>fetch(`/api/comics/${id}/issues/${issueId}/grab`,{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(body)}).then(r=>r.json()),
               monitorIssue: (issueId,body)=>fetch(`/api/comics/issues/${issueId}/monitor`,{method:'PUT',headers:{'Content-Type':'application/json'},body:JSON.stringify(body)}).then(r=>r.json()) },
  ...
  books:     { list: ()=>fetch('/api/books').then(r=>r.json()),
               ...
               bulk: body=>fetch('/api/books/bulk',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(body)}).then(r=>r.json()) },

  podcasts:  { list: ()=>fetch('/api/podcasts').then(r=>r.json()),
               search: q=>fetch('/api/podcasts/search?query='+encodeURIComponent(q)).then(r=>r.json()),
               add: body=>fetch('/api/podcasts',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(body)}).then(async r=>{ if(!r.ok) throw new Error((await r.json().catch(()=>({}))).detail||r.statusText); return r.json(); }),
               remove: id=>fetch('/api/podcasts/'+id,{method:'DELETE'}),
               update: (id,body)=>fetch('/api/podcasts/'+id,{method:'PUT',headers:{'Content-Type':'application/json'},body:JSON.stringify(body)}).then(r=>r.json()),
               episodes: id=>fetch('/api/podcasts/'+id+'/episodes').then(r=>r.json()),
               refresh: id=>fetch('/api/podcasts/'+id+'/refresh',{method:'POST'}).then(r=>r.json()),
               downloadEpisode: (pid,eid)=>fetch('/api/podcasts/'+pid+'/episodes/'+eid+'/download',{method:'POST'}).then(r=>r.json()),
               bulk: body=>fetch('/api/podcasts/bulk',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(body)}).then(r=>r.json()) },
  ...
  music:     { list: ()=>fetch('/api/music').then(r=>r.json()),
               ...
               trackPlayed: trackId=>fetch(`/api/music/track/${trackId}/played`,{method:'POST'}).then(r=>r.json()),
               radio: (seedId,limit=20)=>fetch(`/api/music/radio?seed_id=${seedId}&limit=${limit}`).then(r=>r.json()),
               updateTrackTags: (trackId,body)=>fetch(`/api/music/track/${trackId}/tags`,{method:'PATCH',headers:{'Content-Type':'application/json'},body:JSON.stringify(body)}).then(r=>r.json()),
               uploadTrackArtwork: (trackId,file)=>{ const fd=new FormData(); fd.append('file',file); return fetch(`/api/music/track/${trackId}/artwork`,{method:'POST',body:fd}).then(r=>r.json()); } },
  scrobble:  { lastfm: trackId=>fetch('/api/scrobble/lastfm/push',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({track_id:trackId})}).then(r=>r.json()),
               listenbrainz: trackId=>fetch('/api/scrobble/listenbrainz/push',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({track_id:trackId})}).then(r=>r.json()) },
  musicSmartlists: { list: ()=>fetch('/api/music-smartlists').then(r=>r.json()),
               create: body=>fetch('/api/music-smartlists',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(body)}).then(r=>r.json()),
               update: (id,body)=>fetch(`/api/music-smartlists/${id}`,{method:'PATCH',headers:{'Content-Type':'application/json'},body:JSON.stringify(body)}).then(r=>r.json()),
               remove: id=>fetch(`/api/music-smartlists/${id}`,{method:'DELETE'}),
               tracks: id=>fetch(`/api/music-smartlists/${id}/tracks`).then(r=>r.json()) },
};
